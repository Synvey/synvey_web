  ...
  const securityMeasures = [
    {
      ...
      features: [
        ...
        "Zero-knowledge architecture and Perfect forward secrecy",
      ],
      status: "Active",
    },
    {
      ...
      level: "Multi-Factor",
      description:
        "Comprehensive access controls with multi-factor authentication",
      features: [
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-indigo-900 text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div
          className="absolute top-40 right-32 text-3xl opacity-20 animate-bounce"
          style={{ animationDuration: "4s", animationDelay: "1s" }}
        >
          🛡️
        </div>
        <div
          className="absolute bottom-32 left-32 text-5xl opacity-25 animate-bounce"
          style={{ animationDuration: "5s", animationDelay: "2s" }}
        >
          🔐
        </div>
        <div
          className="absolute bottom-20 right-20 text-3xl opacity-30 animate-bounce"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal className="text-center">
            ...
            <p className="text-xl text-blue-200 max-w-4xl mx-auto mb-8 leading-relaxed">
              ...
              with military-grade encryption and continuous monitoring.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              {incidentResponse.map((step, index) => (
                <Reveal key={step.step} delay={index * 150}>
                  <div className="relative">
                    <div
                      className={`w-16 h-16 bg-${step.color}-500 rounded-full flex items-center justify-center text-white font-bold text-xl mx-auto mb-4 shadow-lg shadow-${step.color}-500/50 relative z-10`}
                    >
                      {step.step}
                    </div>
                    <div className="text-center mt-15">
                      ...
                      <span
                        className={`inline-block px-3 py-1 bg-${step.color}-500/20 text-${step.color}-300 text-xs rounded-full`}
                      >
                        {step.time}
                      </span>
                    </div>
          ...
          <Reveal>
            <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 rounded-3xl p-12 text-center shadow-2xl">
              ...
              <div className="absolute inset-0">
                ...
                <div
                  className="absolute bottom-4 right-4 w-32 h-32 bg-white/10 rounded-full animate-pulse"
              ...
              <div className="relative">
                ...
                <p className="text-xl opacity-90 mb-10 max-w-3xl mx-auto leading-relaxed">
                  Trust in our commitment to security. Your data is protected by
                  the same measures used by Fortune 500 companies and government
                  institutions.
                </p>
