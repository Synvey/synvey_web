...
export default function CookiePolicy() {
  ...
  const cookieTypes = [
    ...
    },
    {
      ...
      icon: "🎯",
      color: "orange",
      description: "Show relevant ads and track performance",
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-cyan-50 dark:from-slate-900 dark:via-blue-900/20 dark:to-cyan-900/20">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div
          className="absolute top-1/4 left-1/4 w-32 h-32 bg-blue-400/20 rounded-full blur-2xl animate-bounce"
          style={{ animationDuration: "3s" }}
        />
        <div
          className="absolute top-3/4 right-1/4 w-40 h-40 bg-cyan-400/20 rounded-full blur-2xl animate-bounce"
          style={{ animationDuration: "4s", animationDelay: "1s" }}
        />
        <div
          className="absolute top-1/2 left-1/2 w-24 h-24 bg-indigo-400/20 rounded-full blur-xl animate-bounce"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Reveal className="text-center">
            ...
            <p className="text-xl text-slate-700 dark:text-slate-300 max-w-4xl mx-auto mb-8 leading-relaxed">
              ...
              personalized content, and analyze our traffic. Learn about the
              different types of cookies we use and how you can control them.
            </p>
          ...
          <Reveal>
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-slate-600 dark:text-slate-400 max-w-3xl mx-auto">
                Each type of cookie serves a different purpose. You can control
            ...
            {cookieTypes.map((cookie, index) => {
              ...
              return (
                <Reveal key={cookie.id} delay={index * 100}>
                  <div
                    className={`group relative overflow-hidden bg-white/80 dark:bg-slate-800/80 backdrop-blur-sm rounded-3xl border ${colors.border} p-8 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2`}
                  >
                    {/* Background Gradient */}
                    <div
                      className={`absolute inset-0 bg-gradient-to-br ${colors.bg} opacity-5 group-hover:opacity-10 transition-opacity duration-500`}
                    />
                        ...
                        <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                            {cookie.examples.map((example, i) => (
                              <span
                                key={i}
                                className={`px-3 py-1 ${colors.bgLight} ${colors.text} text-xs rounded-full`}
                              >
                                {example}
                              </span>
                            ))}
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="text-center">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-sm">
                    Configure cookie preferences directly in your browser's
                    privacy settings
                  </p>
                </div>
                ...
                <div className="text-center">
                  ...
                  <p className="text-slate-600 dark:text-slate-400 text-sm">
                    Reach out to our privacy team for personalized cookie
          ...
          <Reveal>
            <div className="relative overflow-hidden bg-gradient-to-r from-blue-600 via-indigo-500 to-cyan-500 rounded-3xl p-12 text-center text-white shadow-2xl">
              ...
              <div className="absolute inset-0">
                ...
                <div
                  className="absolute bottom-4 right-4 w-16 h-16 bg-white/10 rounded-full animate-ping"
              ...
              <div className="relative">
                ...
                <p className="text-xl opacity-90 mb-10 max-w-3xl mx-auto leading-relaxed">
                  Your privacy matters to us. Customize your cookie preferences
                  to create the perfect balance between functionality and
                  privacy protection.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-6 justify-center">
                  <Button
                    asChild
                    size="lg"
                    className="bg-white text-emerald-600 hover:bg-emerald-50 hover:scale-105 transition-all duration-300"
                  >
